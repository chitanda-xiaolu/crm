                ...
                <el-row :gutter="20">
                    ...
                    <el-col :span="12">
                        <el-form-item label="充值金额：" prop="money">
                            <el-input style="width:80%" v-model="dataForm.money" placeholder="请输入" clearable @blur="adddot"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
...
export default {
    ...
    methods: {
        ...mapActions({ flRechargeData: 'flRechargeData', accountData: 'accountData' }),
        init(id) {
            this.visible = true
            this.isMax = false
