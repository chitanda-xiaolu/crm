                ...
                <el-row :gutter="20">
                    ...
                    <el-col :span="12">
                        <el-form-item label="充值金额：" prop="money">
                            <el-input v-model="dataForm.money" style="width:80%" clearable placeholder="请输入" @blur="adddot"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row :gutter="20">
...
export default {
    ...
    methods: {
        ...mapActions({ cashRechargeData: 'cashRechargeData', accountData: 'accountData' }),
        init(id) {
            this.visible = true
            this.isMax = false
