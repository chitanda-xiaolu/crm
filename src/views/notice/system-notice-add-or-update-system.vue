...
<script>
import { createNotice, editNotice, noticeDetail } from '@/api/notice'
...
export default {
    ...
    mounted() {
        ...
        if (initData) {
            noticeDetail({id: initData}).then(result => {
            ...
            this.$refs['dataForm'].validate(valid => {
                if (valid) {
                    ...
                    if(this.$route.params.id) {
                        ...
                        createNotice(params).then(result => {
                            if(result.code === 200 && result.success) {
